...
export default function AIFastAPI() {
  const project = personalProjects.find(p => p.id === "ai-fastapi");
      ...
      <div className="container mx-auto px-6 pt-12">
        ...
        >
          ...
          <div className="glass-panel w-full rounded-lg mb-16 border border-portfolio-border bg-portfolio-surface overflow-hidden">
            <img src={project.demoImage} alt="AI FastAPI Demo" className="w-full h-auto object-cover" />
          </div>
